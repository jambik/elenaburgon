...
<head>
	...
	<link href="{$page.admpath}css/print.css" type="text/css" rel="stylesheet" media="print" />
  {$page.meta}
...
<table cellpadding="0" cellspacing="3" class="admin-table">
	<tr>
		...
		<td class="admin-menu noprint">
			...
			<div class="menu-item"><a href="{$page.admpath}articles.php"><img src="{$page.admpath}img/news.png" alt="" /> Статьи</a></div>
			<div class="menu-item"><a href="{$page.admpath}gallery.php"><img src="{$page.admpath}img/news.png" alt="" /> Фотогалерея</a></div>
			<div class="menu-hr"></div>
			{if $smarty.session.admin.admin_group == 1}
				<div class="menu-item"><a href="{$page.admpath}settings.php"><img src="{$page.admpath}img/bullet_wrench.png" alt="" /> Настройки</a></div>
