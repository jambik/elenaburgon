<?php
	...
	{
		$smarty->assign("items", $itemsArray = $items->GetItems($portion, $quantity, $sort, $order, $search, $where, true, $select));
	...
	$page["meta"].= "\n\t".'<script src="/'.ADMIN_DIR.'js/base.js" type="text/javascript"></script>'.
									...
									"\n\t".'<link href="/'.INC_JQUERY_UI.'jquery-ui.css" type="text/css" rel="stylesheet" />'.
